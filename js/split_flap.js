...
var FILEPATH = "src/components/bingo.gleam";
  ...
  return [
    ...
    before_paint((dispatch2, root_element) => {
      return on_resize(root_element, () => {
        echo("Resized", undefined, "src/components/bingo.gleam", 71);
...
function update2(model, msg) {
  ...
  if ($ instanceof Ok) {
    ...
    echo("ERROR", undefined, "src/components/bingo.gleam", 98);
    return [model, none2()];
  }
}
...
function register() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError("let_assert", FILEPATH, "components/bingo", 28, "register", "Pattern match failed, no pattern matched the value.", { value: $, start: 783, end: 832, pattern_start: 794, pattern_end: 799 });
  }
...
function main() {
  let $ = register();
  if (!($ instanceof Ok)) {
    throw makeError("let_assert", FILEPATH2, "split_flap", 4, "main", "Pattern match failed, no pattern matched the value.", { value: $, start: 43, end: 78, pattern_start: 54, pattern_end: 59 });
  }
  return;
}

// .lustre/build/split_flap.mjs
main();
